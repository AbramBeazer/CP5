...
app.get('/api/titles/:username/type/:type', verifyToken, (req, res) => {
...
//clear
app.delete('/api/titles/:username/type/:type', verifyToken, (req, res) => {
	console.log("GOT TO CLEAR");
	console.log(req.params.username);
	console.log(req.params.type);
	if(req.params.username !== req.userID){res.status(403).send("Invalid Credentials"); return;}
